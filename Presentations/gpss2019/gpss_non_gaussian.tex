...
\frame{
    ...
    \centering
    \multiinclude[<+>][format=pdf,graphics={scale=0.7}]{../diagrams/animations/laplace-anim-log-Poisson}
}
\frame{
    \frametitle{Visualization of Laplace}
    %\animategraphics[controls]{1}{../diagrams/laplace-anim}{0}{6}
    \centering
    \multiinclude[<+>][format=pdf,graphics={scale=0.7}]{../diagrams/animations/laplace-anim-full-Poisson}
}

\frame{
    \frametitle{Visualise of Laplace - Bernoulli}
    \centering
    \multiinclude[<+>][format=pdf,graphics={scale=0.7}]{../diagrams/animations/laplace-anim-full-Bernoulli}
}
...
\frame{
    \frametitle{Bonus}
    HOW TO ENSURE YOU HAVE THE RIGHT LIKELIHOOD?
    WHAT TESTS CAN BE DONE?
    HOW DO WE KNOW OUR APPROXIMATION IS GOOD ENOUGH?
}
